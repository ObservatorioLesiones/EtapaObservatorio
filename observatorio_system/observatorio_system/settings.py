...
DATABASES = {
    'default': {
        ...
        'NAME': 'observatorio_db',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = '&amp;pqte#jekl5czu@a#4e@j^(%2#t%=f=pk=q0hylxu8h$)g2t(%'
...
ROOT_URLCONF = 'observatorio_system.urls'
